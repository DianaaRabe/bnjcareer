import { FileText, Globe, Video, type LucideIcon } from 'lucide-react'
...
export const ACCESS_LABEL_IDS: Record<ResourceAccess, string> = {
  [ResourceAccess.Free]: 'coach.resources.access.free',
  [ResourceAccess.Paid]: 'coach.resources.access.paid',
  [ResourceAccess.Premium]: 'coach.resources.access.premium',
}

export const ACCESS_ORDER = [ResourceAccess.Free, ResourceAccess.Paid, ResourceAccess.Premium]
